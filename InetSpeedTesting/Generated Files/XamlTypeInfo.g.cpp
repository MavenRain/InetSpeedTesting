...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"InetSpeedTesting.MainPage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::InetSpeedTesting::MainPage(); 
            };
        userType->SetIsLocalType();
        return userType;
    }

    if (typeName == L"InetSpeedTesting.Datum")
    {
        ...
        userType->KindOfType = ::Windows::UI::Xaml::Interop::TypeKind::Custom;
        userType->AddMemberName(L"DownloadBW");
        userType->AddMemberName(L"RTT");
        userType->AddMemberName(L"TestNum");
...
{
    if (longMemberName == L"InetSpeedTesting.Datum.DownloadBW")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"DownloadBW", L"Single");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::InetSpeedTesting::Datum^)instance;
                auto value = ref new ::Platform::Box<::default::float32>(that->DownloadBW);
                return value;
            };
        ...
        xamlMember->Setter =
            [](Object^ instance, Object^ value) -> void
            {
                ...
                that->DownloadBW = boxedValue->Value;
            };
        return xamlMember;
    }

    if (longMemberName == L"InetSpeedTesting.Datum.RTT")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"RTT", L"Single");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::InetSpeedTesting::Datum^)instance;
                auto value = ref new ::Platform::Box<::default::float32>(that->RTT);
                return value;
            };
        ...
        xamlMember->Setter =
            [](Object^ instance, Object^ value) -> void
            {
                auto that = (::InetSpeedTesting::Datum^)instance;
                auto boxedValue = (::Platform::IBox<::default::float32>^)value;
                that->RTT = boxedValue->Value;
            };
        return xamlMember;
    }

    if (longMemberName == L"InetSpeedTesting.Datum.TestNum")
    {
        ::XamlTypeInfo::InfoProvider::XamlMember^ xamlMember = ref new ::XamlTypeInfo::InfoProvider::XamlMember(this, L"TestNum", L"UInt32");
        xamlMember->Getter =
            [](Object^ instance) -> Object^
            {
                auto that = (::InetSpeedTesting::Datum^)instance;
                auto value = ref new ::Platform::Box<::default::uint32>(that->TestNum);
                return value;
            };
